                              ...
                              <tr>
                                 <td>
                                    <table style="min-width: 300px;" border="0" cellspacing="0" cellpadding="0">
                                       <tbody>
                                          <tr>
                                          <td style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 16px; color: #202020; line-height: 1.5; padding-top: 28px;">{{$content}}</td>
                                          </tr>
                                          <tr height="16px"></tr>
                                          <tr>
                                             <td>
                                                <table style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 12px; color: #B9B9B9; line-height: 1.5;">
                                                   <tbody>
                                                      <tr>
                                                         <td>此电子邮件地址无法接收回复。要就此提醒向我们提供反馈，请<a href="mailto:mail@stario.net?Subject=Wemesh_Feedback" style="text-decoration: none; color: #4285F4;" target="_blank">点击此处</a>。</td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
                     ...
                     <td>
                        <table style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 10px; color: #666666; line-height: 18px; padding-bottom: 10px">
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                    <div style="direction: ltr; text-align: left">青岛世达奥科网络技术有限公司</div>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
